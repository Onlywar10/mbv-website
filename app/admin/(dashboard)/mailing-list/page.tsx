		...
		<div>
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="mt-1 text-sm text-muted-foreground">
						Send emails to opted-in clients
					</p>
				</div>
			...
			<Card className="mt-8 rounded-sm ring-1 ring-border shadow-sharp">
				<CardHeader>
					...
					<CardDescription>
						Write and send an email to all clients who have opted in to communications.
						Attachments are uploaded to cloud storage and linked in the email.
					</CardDescription>
				</CardHeader>
				<CardContent>
