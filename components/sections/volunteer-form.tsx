			...
			<section className="bg-muted py-20">
				<div className="mx-auto max-w-3xl px-6 text-center">
					...
					>
						...
						<h3 className="text-2xl font-bold text-primary">Thank You for Signing Up!</h3>
						<p className="text-muted-foreground">
							We&apos;ve received your volunteer interest form. A member of our team will reach out
							to you within a few days with next steps and upcoming opportunities. We appreciate
