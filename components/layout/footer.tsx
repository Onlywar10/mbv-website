        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              Serving the disabled veteran community of Monterey Bay through
              recreational fishing, whale watching, and community events — free
              of charge since 1987.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-xs text-white/50">
              &copy; {new Date().getFullYear()} Monterey Bay Veterans, Inc. All
              rights reserved. 501(c)(3) Non-Profit Organization.
            </p>
            <p className="text-xs text-white/50">
              Serving disabled veterans since 1987
            </p>
          </div>
        </div>
      </div>
