...
import { Accessibility, Users, Heart } from "lucide-react";
...
import { milestones, team, impactStats, programs } from "@/lib/data";
            ...
            <ScrollReveal direction="left">
              <div className="space-y-6">
                <p className="text-lg leading-relaxed text-foreground/90">
                  Monterey Bay Veterans, Inc. is dedicated to serving the
                  disabled veteran community of Monterey Bay, providing
                  recreational fishing, whale watching, and community events at
                  no cost to veterans through the generous support of sponsors
                  and donors.
                </p>
                <p className="text-base leading-relaxed text-muted-foreground">
                  For nearly four decades, we have been committed to the belief
                  that the healing power of the ocean, the camaraderie of shared
                  experience, and the dignity of accessible recreation can make a
                  profound difference in the lives of those who have served our
                  country.
                </p>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <ScrollReveal direction="right">
              <div className="space-y-6">
                ...
                <p className="text-lg leading-relaxed text-foreground/90">
                  The Pescador is the heart of our fleet — a fully
                  wheelchair-accessible vessel operating out of Monterey Harbor.
                  Purpose-built for inclusive maritime experiences, she allows
                  disabled veterans to enjoy deep-sea fishing, whale watching,
                  and the beauty of Monterey Bay without barriers.
                </p>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-rust" />
                    ADA-compliant throughout with wide passageways and roll-on
                    access
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-rust" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-rust" />
                    Experienced volunteer crew trained in accessibility
                    assistance
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-rust" />
        ...
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <ScrollReveal>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Whether you want to join us on the water, volunteer your time, or
              support our mission through a donation, there are many ways to make
              a difference in a veteran&apos;s life.
            </p>
