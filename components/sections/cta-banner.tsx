      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <ScrollReveal>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/85">
            Whether you volunteer your time, donate to our programs, or simply
            spread the word — every act of support helps a veteran experience the
            healing power of the ocean. Together, we can serve those who served.
          </p>
