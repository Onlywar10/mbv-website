					...
					<ScrollReveal direction="left">
						<div>
							...
							<p className="mt-6 text-lg leading-relaxed text-muted-foreground">
								...
								life for disabled veterans through the therapeutic power of the ocean. What started
								as a single wheelchair-accessible salmon derby has grown into a year-round program
								impacting over 5,000 veterans annually.
							</p>
					...
					<ScrollReveal direction="right" delay={0.2}>
						<div className="relative">
							...
							<div className="absolute -bottom-6 -left-6 rounded-sm bg-white p-4 shadow-sharp ring-1 ring-border">
								...
								<div className="text-sm font-medium text-ink">Years Serving Veterans</div>
							</div>
						</div>
					</ScrollReveal>
				</div>
