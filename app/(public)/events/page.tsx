...
import { Phone, Mail, MapPin, User, Accessibility } from "lucide-react";
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          We provide wheelchair-accessible shuttles for disabled
                          veterans attending local community events, including
                          raceway, golf, and fairground events throughout
                          Monterey County.
                        </p>
                      </div>
                    </div>
                ...
                <Card className="rounded-sm bg-ink text-cream shadow-sharp">
                  <CardContent className="pt-2">
                    ...
                    <p className="text-sm text-primary-foreground/80">
                      Whether you are a veteran looking to get out on the water,
                      a volunteer eager to give back, or a supporter wanting to
                      make a difference, we welcome you. Reach out today and
                      become part of the MBV family.
                    </p>
                  </CardContent>
                </Card>
              </div>
